...
for i in "${!SeqName[@]}"; do
    {
        ...
        # ./vvencFFapp -c ../cfg_vvenc/intra_lossless.cfg -c ../cfg_vvenc/vtm/encoder_intra_vtm.cfg -c ../cfg_vvenc/vtm/lossless.cfg -c ../cfg/per-sequence/${SeqName[$i]}.cfg $para >./${SeqName[$i]}_enc_vvenc.log
        ./vvencFFapp -c ../cfg_vvenc/intra_lossless.cfg -c ../cfg/per-sequence/${SeqName[$i]}.cfg $para >./${SeqName[$i]}_enc_vvenc.log
    }
done
