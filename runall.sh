...
do
{
    ...
    cd $basedir/bin_src_forLBonly
    ./TAppEncoderStatic -c ../cfg/encoder_intra_main_LL.cfg -c ../cfg/per-sequence/${cfg_name[$i]}.cfg $para > ./${cfg_name[$i]}_enc_src_forLBonly.log
}&
done
